    ...
    return (
      <section className="block">
        ...
        <p>
          ...
          ES2015 modules, use as you would anything else:
        </p>
        ...
        <Codeblock>{umdJs}</Codeblock>
        <p>
          You can find the library on <code>window.ReactRangeslider</code>.
          Optionally you can drop in the default styles by adding the
          stylesheet.
        </p>
        <Codeblock>{umdCss}</Codeblock>
      </section>
    );
  }
}
